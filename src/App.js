...
export default function App() {
  ...
  const experiences = [
    { 
      ...
      achievements: ['Developed 40+ internal PIM reports', 'Evaluated securities across 12 market sectors', 'Improved VaR risk management by 18%']
    },
    { 
            ...
            <div className="bg-gradient-to-br from-gray-800 via-gray-800 to-gray-900 border border-gray-700 rounded-xl p-8 relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <div className="flex flex-wrap gap-2 mb-6 text-[13px]">
                  {['Quant Finance','Fintech','AI/ML','Data Science','Algo Trading','Full-Stack SWE','Portfolio Management','Risk Analytics','Crypto/Blockchain','Private Equity'].map((t)=>(
